...
Davit compose plan|up [-f <file>] [--env-file <path>] [--profile <p>] [service…]   # plan: print only / up: create & start; file autodiscovered, .env + ${VAR} interpolation, named services + their dependencies
