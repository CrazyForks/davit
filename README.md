...
Davit compose plan|up [-f <file>] [--profile <p>] [service…]   # plan: print only / up: create & start; file autodiscovered, named services + their dependencies
